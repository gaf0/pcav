...
if uploaded_file:
    ...
    if st.button("Generate & Style Schedule"):
        ...
        try:
            ...
            contract_col = df.columns[2]
            task_cols = df.columns[3:]
            ...
            st.success("Drawing complete! Preview of the first 5 weeks:")
            st.dataframe(final_df.head()) # Show a preview in the app
